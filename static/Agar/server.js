...
io.sockets.on('connection',
  ...
  function(socket) {
    ...
    socket.on('start',
      function(data) {
        console.log(data.hostId + " id: " + socket.id + " x: " + data.x + " y: " + data.y + " r: " + data.r);
        var blob = new Blob(data.hostId, socket.id, data.x, data.y, data.r);
        blobs.push(blob);
      }
